...
// function which shows the modal by changing the style of guidance-Modal to "block"
const showModal = () => {
    guidanceModal.style.display = "block";
  };
  
  // function which hides the modal by changing the style of guidance-Modal to "none"
  const closeModal = () => {
